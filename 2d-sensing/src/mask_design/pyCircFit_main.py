# 10/13/2017 [Chan U Lei]
# modified by Chris Wang
...
def circlefit(freqs, Xn, Yn, fittype = 'hanger', plotlabel = '', fitQscl = 5.0, show_plots = True, plot_detail = False, circle_plot_limits = None, print_results = False, amp_cal_transmission = 1, fano = False):
